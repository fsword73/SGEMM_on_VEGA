...
__device__ void DotProductMacros()
{
	...
	asm volatile(".macro outerDotproduct_sum_no_reuse sum_offset, v_matB_offset\n \
					v_fma_f32  v[v_SUM + \\sum_offset], v[\\v_matB_offset + 0], s[s_matrixA_m16 + 0 + 8 *(0x7 & \\sum_offset)], v[v_SUM + \\sum_offset]\n  \
					v_fma_f32  v[v_SUM +1+ \\sum_offset], v[\\v_matB_offset + 0], s[s_matrixA_m16 + 0 + 8 + 8 *(0x7 & \\sum_offset)], v[v_SUM +1+ \\sum_offset]\n  \
					v_fma_f32  v[v_SUM + \\sum_offset], v[\\v_matB_offset + 1], s[s_matrixA_m16 + 1 + 8 *(0x7 & \\sum_offset)], v[v_SUM + \\sum_offset]\n  \
					v_fma_f32  v[v_SUM +1+ \\sum_offset], v[\\v_matB_offset + 1], s[s_matrixA_m16 + 1 + 8 + 8 *(0x7 & \\sum_offset)], v[v_SUM +1+ \\sum_offset]\n  \
					v_fma_f32  v[v_SUM + \\sum_offset], v[\\v_matB_offset + 2], s[s_matrixA_m16 + 2 + 8 *(0x7 & \\sum_offset)], v[v_SUM + \\sum_offset]\n  \
					v_fma_f32  v[v_SUM +1+ \\sum_offset], v[\\v_matB_offset + 2], s[s_matrixA_m16 + 2 +8+ 8 *(0x7 & \\sum_offset)], v[v_SUM +1+ \\sum_offset]\n  \
					v_fma_f32  v[v_SUM + \\sum_offset], v[\\v_matB_offset + 3], s[s_matrixA_m16 + 3 + 8 *(0x7 & \\sum_offset)], v[v_SUM + \\sum_offset]\n  \
					v_fma_f32  v[v_SUM +1+ \\sum_offset], v[\\v_matB_offset + 3], s[s_matrixA_m16 + 3 +8+ 8 *(0x7 & \\sum_offset)], v[v_SUM +1+ \\sum_offset]\n  \
					v_fma_f32  v[v_SUM + \\sum_offset], v[\\v_matB_offset + 4], s[s_matrixA_m16 + 4 + 8 *(0x7 & \\sum_offset)], v[v_SUM + \\sum_offset]\n  \
					v_fma_f32  v[v_SUM + 1+ \\sum_offset], v[\\v_matB_offset + 4], s[s_matrixA_m16 + 4 +8+ 8 *(0x7 & \\sum_offset)], v[v_SUM +1+ \\sum_offset]\n  \
					v_fma_f32  v[v_SUM + \\sum_offset], v[\\v_matB_offset + 5], s[s_matrixA_m16 + 5 + 8 *(0x7 & \\sum_offset)], v[v_SUM + \\sum_offset]\n  \
					v_fma_f32  v[v_SUM +1+ \\sum_offset], v[\\v_matB_offset + 5], s[s_matrixA_m16 + 5 +8+ 8 *(0x7 & \\sum_offset)], v[v_SUM +1+ \\sum_offset]\n  \
					v_fma_f32  v[v_SUM + \\sum_offset], v[\\v_matB_offset + 6], s[s_matrixA_m16 + 6 + 8 *(0x7 & \\sum_offset)], v[v_SUM + \\sum_offset]\n  \
					v_fma_f32  v[v_SUM +1+ \\sum_offset], v[\\v_matB_offset + 6], s[s_matrixA_m16 + 6 +8+ 8 *(0x7 & \\sum_offset)], v[v_SUM +1+ \\sum_offset]\n  \
					v_fma_f32  v[v_SUM + \\sum_offset], v[\\v_matB_offset + 7], s[s_matrixA_m16 + 7 + 8 *(0x7 & \\sum_offset)], v[v_SUM + \\sum_offset]\n  \
					v_fma_f32  v[v_SUM +1+ \\sum_offset], v[\\v_matB_offset + 7], s[s_matrixA_m16 + 7 +8+ 8 *(0x7 & \\sum_offset)], v[v_SUM +1+ \\sum_offset]\n  \
					s_load_dwordx8  s[s_matrixA_m16+8 *(0x7 & \\sum_offset):s_matrixA_m16+8 *(0x7 & \\sum_offset)+7], s[s_matrixA_base:s_matrixA_base+1],     s[s_matrixA_sgpr_addr]\n  \
					s_add_u32       s[s_matrixA_sgpr_addr], 	s[s_matrixA_sgpr_addr], s[s_lda]\n  \
					s_load_dwordx8  s[s_matrixA_m16+8 *(0x7 & \\sum_offset)+8:s_matrixA_m16+8 *(0x7 & \\sum_offset)+7+8], s[s_matrixA_base:s_matrixA_base+1],     s[s_matrixA_sgpr_addr]\n  \
					s_add_u32       s[s_matrixA_sgpr_addr], 	s[s_matrixA_sgpr_addr], s[s_lda]\n  \
	.endmacro \n"::);
	...
	{
		asm volatile(".macro DotProductGroupA groupindex  \n  \
					outerDotproduct_sum_no_reuse (\\groupindex * 8 + 0),  v_matrixB_k8A \n   \
					outerDotproduct_sum_no_reuse (\\groupindex * 8 + 2),  v_matrixB_k8A \n   \
					outerDotproduct_sum_no_reuse (\\groupindex * 8 + 4),  v_matrixB_k8A \n   \
					outerDotproduct_sum_no_reuse (\\groupindex * 8 + 6),  v_matrixB_k8A \n   \
		.endmacro \n"::);

		asm volatile(".macro DotProductGroupB groupindex \n \
					outerDotproduct_sum_no_reuse (\\groupindex * 8 + 0),  v_matrixB_k8B \n \
					outerDotproduct_sum_no_reuse (\\groupindex * 8 + 2),  v_matrixB_k8B \n \
					outerDotproduct_sum_no_reuse (\\groupindex * 8 + 4),  v_matrixB_k8B \n \
					outerDotproduct_sum_no_reuse (\\groupindex * 8 + 6),  v_matrixB_k8B \n \
	.endmacro \n"::);
